...
import 'package:curavault_admin/admin/pages/production_readiness_page.dart';
      ...
      routes: [
        ...
        ShellRoute(
          ...
          routes: [
            ...
            GoRoute(path: AppRoutes.websiteSeo, name: 'websiteSeo', pageBuilder: (context, state) => const NoTransitionPage(child: WebsiteCmsStatusPage(section: WebsiteCmsSection.seo))),
            GoRoute(path: AppRoutes.websitePricing, name: 'websitePricing', pageBuilder: (context, state) => const NoTransitionPage(child: WebsiteCmsStatusPage(section: WebsiteCmsSection.pricing))),
            GoRoute(path: AppRoutes.websiteFaqs, name: 'websiteFaqs', pageBuilder: (context, state) => const NoTransitionPage(child: WebsiteCmsStatusPage(section: WebsiteCmsSection.faqs))),
            GoRoute(path: AppRoutes.websiteTestimonials, name: 'websiteTestimonials', pageBuilder: (context, state) => const NoTransitionPage(child: WebsiteCmsStatusPage(section: WebsiteCmsSection.testimonials))),
            GoRoute(path: AppRoutes.websiteCampaigns, name: 'websiteCampaigns', pageBuilder: (context, state) => const NoTransitionPage(child: WebsiteCmsStatusPage(section: WebsiteCmsSection.campaigns))),
            GoRoute(path: AppRoutes.websiteAssets, name: 'websiteAssets', pageBuilder: (context, state) => const NoTransitionPage(child: WebsiteCmsStatusPage(section: WebsiteCmsSection.assets))),
