            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  if (allowed(AppRoutes.developmentOverview)) _SidebarItem(label: 'Overview', icon: Icons.account_tree_outlined, route: AppRoutes.developmentOverview, currentLocation: currentLocation, onNavigate: onNavigate),
                  if (allowed(AppRoutes.developmentTasks)) _SidebarItem(label: 'Tasks', icon: Icons.task_alt_outlined, route: AppRoutes.developmentTasks, currentLocation: currentLocation, onNavigate: onNavigate),
