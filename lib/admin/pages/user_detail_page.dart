  ...
  Widget build(BuildContext context) {
    ...
    return AdminCard(
      ...
      child: Column(
        ...
        children: [
          Text('No summary record was found for $userId.',
              style: Theme.of(context)
                  .textTheme
                  .bodyMedium
                  ?.copyWith(color: cs.onSurfaceVariant)),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        AdminCard(
          ...
          child: _KeyValueGrid(
            rows: [
              ...
              (
                'AI tokens (mo)',
                formatCompactInt(detail.aiTokensUsedThisMonth)
              ),
              (
                'AI requests (mo)',
                formatCompactInt(detail.aiRequestsThisMonth)
              ),
            ],
          ),
        ),
        const SizedBox(height: AppSpacing.lg),
        AdminCard(
          header: Text('Technical diagnostics',
              style: Theme.of(context)
                  .textTheme
                  .titleMedium
                  ?.copyWith(fontWeight: FontWeight.w800)),
        ...
        AdminCard(
          ...
          child: _KeyValueGrid(
            rows: [
              ...
              (
                'AI token limit (mo)',
                formatCompactInt(detail.aiTokenLimitThisMonth)
              ),
        ...
        AdminCard(
          ...
          child: _KeyValueGrid(
            rows: [
              ...
              (
                'Support notes',
                detail.supportNotes?.trim().isNotEmpty == true
                    ? 'Present (redacted)'
                    : '—'
              ),
            ],
...
class _AdminActionsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      return AdminCard(
        header: Text('Admin actions',
            style: Theme.of(context)
                ...
                .titleMedium
                ?.copyWith(fontWeight: FontWeight.w800)),
        child: Text('No admin role loaded.',
            style: Theme.of(context)
                .textTheme
                .bodyMedium
                ?.copyWith(color: cs.onSurfaceVariant)),
    ...
    final actions = AdminUserAction.values
        .where((a) => AdminRbac.canPerformUserAction(role, a))
        .toList();
    return AdminCard(
      header: Text('Admin actions',
          style: Theme.of(context)
              ...
              for (final a in actions)
                OutlinedButton.icon(
                  onPressed: () => showModalBottomSheet<void>(
                    ...
                    builder: (_) => AdminActionConfirmSheet(
                        userId: userId, action: a, role: role),
                  ),
  ...
  IconData _iconFor(AdminUserAction a) => switch (a) {
        ...
        AdminUserAction.triggerComplianceExport =>
...
class AdminActionConfirmSheet extends StatefulWidget {
  ...
  @override
  State<AdminActionConfirmSheet> createState() =>
      _AdminActionConfirmSheetState();
}
                    ...
                    child: FilledButton(
                      onPressed: _submitting
                          ...
                          : () async {
                              ...
                              try {
                                final admin =
                                    context.read<AdminStore>().currentAdmin;
                                if (admin == null) {
                                  throw Exception('Admin profile not loaded');
                                }

                                final params = <String, dynamic>{};
                                if (needsParam &&
                                    _param.text.trim().isNotEmpty) {
